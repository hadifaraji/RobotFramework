...
${Country}     انگلستان
${ToCityInternational}         استانبول
${ToCodeInternational_City}    IST
*** Test Cases ***

Buying a one-way international plane ticket Mobile  #PASS
     Given Login User   ${Username}  ${password1}
     Given Select part international flight Mobile
     When Search domestic flight tickets     ${FromCity}  ${FromCode_City}  ${ToCityInternational}   ${ToCodeInternational_City}
